...
!(function () {
    ...
    jt = (e, t) =>
      ((e, t, o = y) =>
        o(t)
          ...
          : D(e, Z(t))
          ? C.some(t)
          : ct(t, e.join(','), (e) => we(e, 'table') || o(e)))(['td', 'th'], e, t),
    It = (e) => _t(e, 'th,td'),
  ...
  const Hr = (e, t, o, n) => {
    ...
    $r = (e, t) =>
      ((e, t, o) =>
        o.length > 0 ? ((e, t, o, n) => n(e, t, o[0], o.slice(1)))(e, t, o, Hr) : C.none())(
        Vr,
        (t, o) => e(o),
        t
      ),
    ...
    Yr = (e, t, o) =>
      mt(e, t).bind((t) =>
        mt(e, o).bind((e) => $r(Ur, [t, e]).map((o) => ({ first: t, last: e, table: o })))
      ),
    Jr = (e, t, o, n, r) =>
    ...
    Is = (e, t = !1) =>
      et(e) ? e.dom.isContentEditable : js(e).fold(g(t), (e) => 'true' === Ps(e)),
    ...
    Qs = (e, t) =>
      Ys(e, t, x).map((e) => ({ cells: e, generators: t.generators, clipboard: t.clipboard })),
    Xs = (e, t) => Ys(e, t, x),
    ...
    wl = (e, t, o, n) =>
      ((e, t, o, n) => void 0 !== _o(e[t], o) && t > 0 && n(_o(e[t - 1], o), _o(e[t], o)))(
        e,
        t,
        o,
        n
    ...
    Cl = (e, t, o, n, r) => {
      const s = jo(e).rows,
        l = j(t, (e) => xl(s, e, n)),
        a = E(s, (e) => Rs(e.cells)),
        c = ((e, t) => (I(t, h) && Rs(e) ? x : (e, o, n) => !('th' === Z(e.element) && t[o])))(
          l,
          a
        ),
        i = (
    ...
    Kl = (e) =>
      W(e, (e, t) => (O(e, (e) => e.row === t.row) ? e : e.concat([t])), []).sort(
        (e, t) => e.row - t.row
      ),
    Yl = (e, t) => (o, n, r, s, l) => {
      const a = Kl(n),
        ...
        i = ((e, t, o, n, r, s, l) => {
          ...
          const f = [...a, ...u],
            g = ((e, t) =>
              I(t, h) && Rs(e.cells) ? x : (e, o, n) => !('th' === Z(e.element) && t[n]))(i, d),
            p = (
              (e, t) => (o, n, r) =>
          ...
          (i, m, d = !1) => {
            ...
            return s(i)
              ? n(i, m, f, g).bind((n) => {
                  ...
                  return (
                    et(i) && (kr(i), d || Wa(e, i.dom, c)), r.map((e) => ({ rng: e, effect: c }))
                  )
                })
              : C.none()
          },
    ...
    lc = {
      ...rc,
      from: (e) =>
        bt(e, '%') ? sc('%', rc.percent, e) : bt(e, 'px') ? sc('px', rc.pixels, e) : rc.invalid(e),
    },
    ac = (e, t, o) => {
      const n = lc.from(o),
        r = I(e, (e) => '0px' === e)
    ...
    Tc = (e, t, o, n, s) => {
      const l = ((e) => {
          ...
          return t.isSet('table_default_styles')
            ? o
            : ((e, t) =>
                Ya(e) || !Qa(e) ? t : Ka(e) ? { ...t, width: Pa(e) } : { ...t, width: Ia })(e, o)
        })(e),
  ...
  const Dc = 'x-tinymce/dom-table-',
    ...
    Jc = (e, t, o) =>
      t(pe.fromDom(o.startContainer), o.startOffset, pe.fromDom(o.endContainer), o.endOffset),
    Qc = (e, t) => {
      const o = ((e, t) =>
        t.match({
  ...
  const Zc = (e, t, o, n) => ({ start: e, soffset: t, finish: o, foffset: n }),
    ...
    yi = ae('br'),
    xi = (e, t, o) =>
      t(e, o).bind((e) => (re(e) && 0 === cr(e).trim().length ? xi(e, t, o) : C.some(e))),
    Ci = (e, t, o, n) =>
      ((e, t) =>
        Ne(e, t)
          .filter(yi)
    ...
    ki = (e, t, o) =>
      ne(t)
        ...
        : C.none(),
    Ei = (e, t) =>
      ne(t) ? Oi(e, t).map(Di) : re(t) ? e.getRangedRect(t, 0, t, dr(t)).map(Di) : C.none(),
      ...
      dt(n, 'td,th', t).bind((n) =>
        dt(n, 'table', t).bind((s) =>
          ((e, t) => at(e, (e) => Re(e).exists((e) => ye(e, t)), void 0).isSome())(r, s)
            ? ((e, t, o) =>
                _i(e, t, o).bind((n) => Mi(e, t, n.element, n.offset, o, 20).map(e.fromSitus)))(
                e,
                t,
                o
              ).bind((e) =>
    ...
    fm = (e) => {
      if (e.rangeCount > 0) {
        ...
        return C.some(
          Zc(pe.fromDom(t.startContainer), t.startOffset, pe.fromDom(o.endContainer), o.endOffset)
        )
      }
      return C.none()
    },
                          ...
                          return s.fold(
                            () =>
                              Yr(t, n.firstSelectedSelector, n.lastSelectedSelector).map((e) => {
                                ...
                                return (
                                  r.setRelativeSelection(Fc.on(e.first, 0), o(e.table)),
                                  n.clear(t),
                                  Hc(C.none(), !0)
                                )
                              }),
